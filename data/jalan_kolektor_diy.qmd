...
<qgis version="3.32.3-Lima">
  <identifier>jalan_diy</identifier>
  <parentidentifier></parentidentifier>
  <language>ENG</language>
  <type>dataset</type>
  <title>jalan_diy</title>
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link name="File Geodatabase Feature Class" url="file://\\PSJSDS-4-PC\G$\TrainingPakuan.gdb" mimeType="" description="" type="Local Area Network" size="" format=""/>
  </links>
  <dates/>
  <fees></fees>
